...
class ChampionshipsControllerTest < ActionController::TestCase
  ...
  test "should create championship" do
    assert_difference('Championship.count') do
      post :create, championship: { active: @championship.active, desc: @championship.desc, end_date: @championship.end_date, name: @championship.name, start_date: @championship.start_date }
    end
  ...
  test "should update championship" do
    put :update, id: @championship, championship: { active: @championship.active, desc: @championship.desc, end_date: @championship.end_date, name: @championship.name, start_date: @championship.start_date }
    assert_redirected_to championship_path(assigns(:championship))
  end
